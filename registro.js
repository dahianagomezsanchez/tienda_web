...
function validacion(formulario) {
    ...
    if (!expCorreo.test(formulario.correo.value)) {
        document.getElementById("ErrorCorreo").innerText =
            "El correo debe contener @ y un dominio";
    ...
    if (!expcontrasena.test(formulario.contrasena.value)) {
        document.getElementById("ErrorContrasena").innerText =
            "La contaseña debe contener 8 carácteres entre letras y números";
    ...
    if (formulario.contrasena.value != formulario.contraconfirm.value) {
        document.getElementById("ErrorConfirmarContrasena").innerText =
